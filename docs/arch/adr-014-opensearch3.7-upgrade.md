...
Furthermore, Elasticsearch moved from the permissive Apache 2.0 license to the less permissive Elastic License and SSPL. As a result, OpenSearch was created as a fork of Elasticsearch 7.10.2, allowing us to continue using an Apache 2.0-licensed search platform.
...
The testing [confirmed][ES-RESULTS] that the Search API's functionality, search results, relevance, and performance remained as expected when running against OpenSearch 3.7.
...
[ES-RESULTS]: https://beisgov.sharepoint.com/:w:/r/sites/GOVUKWeb/Shared%20Documents/General/Search/2025%20-%202026_%20Search/25_26%20Technical/Upgrading_Elasticsearch.docx?d=wd6bc70ac5a1c4096940f845e6a5cfc61&csf=1&web=1&e=ZkngCC
