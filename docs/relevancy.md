...
These no-indexed paths and formats are defined in [`config/govuk_index/indexable_formats.yaml`](https://github.com/alphagov/search-api/blob/master/config/govuk_index/indexable_formats.yaml).
