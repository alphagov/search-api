    ...
    def document
      {
        ...
        armed_forces_covenant_business_company_size: specialist.armed_forces_covenant_business_company_size,
        armed_forces_covenant_business_industry: specialist.armed_forces_covenant_business_industry,
        armed_forces_covenant_business_ownership: specialist.armed_forces_covenant_business_ownership,
        armed_forces_covenant_business_date_signed: specialist.armed_forces_covenant_business_date_signed,
        ...
        design_decision_british_library_number: specialist.design_decision_british_library_number,
        design_decision_hearing_officer: specialist.design_decision_hearing_officer,
        design_decision_date: specialist.design_decision_date,
        design_decision_litigants: specialist.design_decision_litigants,
        destination_country: specialist.destination_country,
        development_sector: specialist.development_sector,
        digital_markets_measure_firm: specialist.digital_markets_measure_firm,
        digital_markets_measure_activity: specialist.digital_markets_measure_activity,
        digital_markets_measure_type: specialist.digital_markets_measure_type,
        digital_markets_measure_state: specialist.digital_markets_measure_state,
        digital_markets_measure_opened: specialist.digital_markets_measure_opened,
        digital_markets_measure_closed: specialist.digital_markets_measure_closed,
        ...
        display_date: details.display_date,
        ...
        farming_grant_type: specialist.farming_grant_type,
        ...
        release_timestamp: details.release_timestamp,
        ...
        sfo_case_date_closed: specialist.sfo_case_date_closed,
        ...
        ukhsa_request_type: specialist.ukhsa_request_type,
