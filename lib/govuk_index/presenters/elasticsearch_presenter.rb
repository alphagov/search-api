    ...
    def document
      {
        ...
        foo_project_type: specialist.foo_project_type,
        foo_project_state: specialist.foo_project_state,
        foo_project_opened_date: specialist.foo_project_opened_date,
        foo_project_closed_date: specialist.foo_project_closed_date,
