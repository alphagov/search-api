  ...
  class IndexGroup
    ...
    def index_for_name(real_name)
      SearchIndices::Index.new(
        @base_uri, real_name, @name, @search_config
      )
    end
    ...
    def create_index
      ...
      Index.new(@base_uri, index_name, @name, @search_config)
    end
    ...
    def current
      Index.new(@base_uri, @name, @name, @search_config)
    end
    ...
    def current_real
      ...
      if current_index.exists?
        Index.new(@base_uri, current.real_name, @name, @search_config)
      end
    end
