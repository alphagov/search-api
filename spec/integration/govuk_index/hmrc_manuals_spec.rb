...
RSpec.describe "HMRC manual publishing" do
  ...
  it "indexes an HMRC manual" do
    ...
    allow(GovukIndex::AllowedFormats).to receive(:allowed_formats).and_return("hmrc_manual" => :all)
  ...
  it "indexes an HMRC manual section" do
    ...
    allow(GovukIndex::AllowedFormats).to receive(:allowed_formats).and_return("hmrc_manual_section" => :all)
