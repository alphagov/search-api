...
RSpec.describe "Manual publishing" do
  ...
  it "indexes a Manual" do
    ...
    allow(GovukIndex::AllowedFormats).to receive(:allowed_formats).and_return("manual" => :all)
  ...
  it "indexes a manual section" do
    ...
    allow(GovukIndex::AllowedFormats).to receive(:allowed_formats).and_return("manual_section" => :all)
