...
RSpec.describe "Manual publishing" do
  ...
  it "indexes a Manual" do
    ...
    allow(GovukIndex::MigratedFormats).to receive(:allowed_formats).and_return("manual" => :all)
  ...
  it "indexes a manual section" do
    ...
    allow(GovukIndex::MigratedFormats).to receive(:allowed_formats).and_return("manual_section" => :all)
