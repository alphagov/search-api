        ...
        expect_document_is_in_rummager(
          {
            "link" => "/bar",
            "parts" => [
              { "slug" => "attachment-1", "url" => "/bar/attachment-1", "title" => "attachment 1", "body" => "body 1" },
              { "slug" => "attachment-2", "url" => "/bar/attachment-2", "title" => "attachment 2", "body" => "body 2" },
              { "slug" => "attachment-3", "url" => "/bar/attachment-3", "title" => "attachment 3", "body" => "body 3" },
            ],
            "attachments" => [
              { "title" => "attachment 1", "content" => "body 1" },
              { "title" => "attachment 2", "content" => "body 2" },
