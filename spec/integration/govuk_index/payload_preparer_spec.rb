...
RSpec.describe "Payload preparation" do
  ...
  context "parts from attachments" do
    it "indexes documents with parts unchanged" do
      ...
      random_example["details"]["parts"] = [{ "slug" => "foo", "title" => "bar", "body" => [{ "content_type" => "text/html", "content" => "baz" }] }]
