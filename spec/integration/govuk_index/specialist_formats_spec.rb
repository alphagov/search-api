...
RSpec.describe "SpecialistFormatTest" do
  ...
  it "specialist publisher finders are correctly indexed" do
    ...
    allow(GovukIndex::IndexableFormats).to receive(:indexable_formats).and_return("finder" => :all)
  ...
  it "specialist documents are correctly indexed" do
    ...
    document_types.sample(3).each do |specialist_document_type|
      ...
      allow(GovukIndex::IndexableFormats).to receive(:indexable_formats).and_return(specialist_document_type => :all)
  ...
  it "esi documents are correctly indexed" do
    ...
    allow(GovukIndex::IndexableFormats).to receive(:indexable_formats).and_return(search_document_type => :all)
