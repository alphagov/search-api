...
RSpec.describe 'GovukIndex::SwitchOnFormatsInGovukIndexTest' do
  before do
    insert_document('government_test', title: 'government answer', link: '/mainstream/answer', format: 'answer')
    insert_document('government_test', title: 'government help', link: '/mainstream/help', format: 'help_page')
