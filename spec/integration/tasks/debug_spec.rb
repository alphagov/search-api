  ...
  describe "debug:show_govuk_link" do
    ...
    describe "when no link is provided" do
      it "prints a helpful message and exits" do
        ...
        }.to output("Missing argument. Usage: rake debug:show_govuk_link[link]\n").to_stderr
    ...
    context "the document exists in the index" do
      it "pretty prints a document from the new content index" do
        ...
        expect(output).to include("_index => govuk_test")
    ...
    context "the document does not exist in the index" do
      it "prints an error message" do
        expect {
          Rake::Task[task_name].invoke(link)
        }.to output("Cannot find /path/to_page in index govuk_test\n").to_stderr.and raise_error(SystemExit)
      end
    end
  end
