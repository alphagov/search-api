...
module RankEvalTestHelpers
  def mock_judgement_data
    {
      "harry potter" => [
        { score: 3, link: "/harry-potter" },
      ],
      "passport" => [
        { score: 3, link: "/government/renew-a-passport" },
      ],
    }
  end
  ...
  def rank_eval_expected_output
    <<~OUTPUT
      Ignoring 1 judgements for /government/renew-a-passport queried with query 'passport'
      harry potter: 1
      passport: 0
      ---
      overall score: 0.5
  ...
  def stub_rank_eval_request
    ...
    stub_request(:get, "#{es_source}/*/_rank_eval")
      .to_return(
        status: 200,
        body: {
          metric_score: 0.5,
