  ...
  describe "#report_request" do
    it "builds the correct RunReportRequest object" do
      ...
      expect(analytics_data).to have_attributes(
        ...
        date_ranges: [have_attributes(start_date: start_date.to_s, end_date: end_date.to_s)],
        dimensions: [
          have_attributes(name: "pagePath"),
          have_attributes(name: "pageTitle"),
        ],
        metrics: [have_attributes(name: "screenPageViews")],
        offset: 0,
        limit: 100,
