...
class SynonymsTest < ShouldaUnitTestCase
  ...
  should "map a two word synonym to the same synonym group at index and search time" do
  ...
  should "understand mapping a search phrase to a different phrase in documents" do
  ...
  should "understand mapping one search phrase to multiple phrases in documents" do
  ...
  should "understand mapping multiple search phrases to one phrase in documents" do
  ...
  should "produce correct config for protecting all the generated synonym terms" do
