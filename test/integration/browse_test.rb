...
class BrowseTest < IntegrationTest
  ...
  def test_browsing_a_valid_section
    @mainstream_solr.stubs(:section).returns([sample_document])
  ...
  def test_browsing_an_empty_section
    @mainstream_solr.stubs(:section).returns([])
  ...
  def test_browsing_a_section_with_popular_item_shows_popular_item_at_top_of_page
    ...
    @mainstream_solr.stubs(:section).returns([doc])
  ...
  def test_ordering_of_popular_items_is_correct
    ...
    @mainstream_solr.stubs(:section).returns([doc1, doc2, doc3, doc4])
  ...
  def test_browsing_section_displays_other_sections
    @mainstream_solr.stubs(:section).returns([sample_document])
    @mainstream_solr.stubs(:facet).with('section').returns([Section.new('bar'), Section.new('section-name'), Section.new('zulu')])
  ...
  def test_should_put_browse_in_section_nav_for_slimmer
    @mainstream_solr.stubs(:facet).returns([])
    get "/browse"
  ...
  def test_browsing_section_list
    @mainstream_solr.stubs(:facet).returns([sample_section])
