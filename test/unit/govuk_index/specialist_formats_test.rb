...
class SpecialistFormatTest < Minitest::Test
  ...
  def test_asylum_support_decision
    custom_metadata = {
  ...
  def test_business_finance_support_scheme
    custom_metadata = {
  ...
  def test_countryside_stewardship_grant
    custom_metadata = {
      "grant_type" => "option",
  ...
  def test_employment_appeal_tribunal_decision
    custom_metadata = {
  ...
  def test_employment_tribunal_decision
    custom_metadata = {
  ...
  def test_european_structural_investment_fund
    custom_metadata = {
  ...
  def test_international_development_fund
    custom_metadata = {
      "closing_date" => "2016-01-01",
      "fund_state" => "open",
      "fund_type" => ["business-support"],
  ...
  def test_service_standard_report
    custom_metadata = {
  ...
  def test_tax_tribunal_decision
    custom_metadata = {
  ...
  def test_vehicle_recalls_and_faults_alert
    custom_metadata = {
