...
class ResultSetPresenterTest < ShouldaUnitTestCase
  ...
  context "results with aggregates and a filter applied" do
    ...
    should "have selected aggregate first" do
      assert_equal({
        value: { "slug" => "hmrc" },
        documents: 5,
      }, @output[:aggregates]["organisations"][:options][0])
    ...
    should "have unapplied aggregate value second" do
      assert_equal({
        value: { "slug" => "hm-magic" },
        documents: 7,
  ...
  context "results with aggregate counting only" do
    ...
    should "have no aggregate values" do
  ...
  context "results with aggregates sorted by ascending count" do
    ...
    should "have aggregates sorted by ascending count" do
      assert_equal [
  ...
  context "results with aggregates sorted by descending count" do
    ...
    should "have aggregates sorted by descending count" do
      assert_equal [
        aggregate_response_magic,
        aggregate_response_hmrc,
      ], @output[:aggregates]["organisations"][:options]
  ...
  context "results with aggregates sorted by ascending slug" do
    ...
    should "have aggregates sorted by ascending slug" do
      assert_equal [
        aggregate_response_magic,
        aggregate_response_hmrc,
      ], @output[:aggregates]["organisations"][:options]
  ...
  context "results with aggregates sorted by ascending link" do
    ...
    should "have aggregates sorted by ascending link" do
      assert_equal [
        aggregate_response_magic,
        aggregate_response_hmrc,
      ], @output[:aggregates]["organisations"][:options]
  ...
  context "results with aggregates sorted by ascending title" do
    ...
    should "have aggregates sorted by ascending title" do
      assert_equal [
        aggregate_response_hmrc,
        aggregate_response_magic,
      ], @output[:aggregates]["organisations"][:options]
  ...
  context "results with aggregates and an org registry" do
    ...
    should "have org aggregate value expanded" do
      assert_equal({
        value: {
          "link" => "/government/departments/hm-magic",
          "title" => "Ministry of Magic",
    ...
    should "have topic aggregate value un-expanded" do
      assert_equal({
  ...
  context "results with aggregate examples" do
    ...
    should "have org aggregate value expanded, and include examples" do
      assert_equal({
        value: {
          "link" => "/government/departments/hm-magic",
          "title" => "Ministry of Magic",
